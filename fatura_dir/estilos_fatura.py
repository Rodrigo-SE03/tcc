...
def geral(worksheet,workbook,dados_dict,categoria,total_row):
    ...
    if categoria == "Verde":
        ...
        worksheet.write('R3','Demanda',header_format)
        worksheet.write('S3',total_row[3],total_custo_format)
        worksheet.write('R4','Demanda Não Utilizada',header_format)
        worksheet.write('S4',total_row[5],total_custo_format)
        worksheet.write('R5','Ultrapassagem',header_format)
        worksheet.write('S5',total_row[7],total_custo_format)
        worksheet.write('R6','Consumo',header_format)
        worksheet.write('S6',total_row[9]+total_row[11],total_custo_format)
        worksheet.write('R7','Reativos',header_format)
        worksheet.write('S7',total_row[13]+total_row[15],total_custo_format)
        worksheet.set_column('R:S',22)
    else:
        ...
        worksheet.write('W3','Demanda',header_format)
        worksheet.write('X3',total_row[2]+total_row[4],total_custo_format)
        worksheet.write('W4','Demanda Não Utilizada',header_format)
        worksheet.write('X4',total_row[6]+total_row[8],total_custo_format)
        worksheet.write('W5','Ultrapassagem',header_format)
        worksheet.write('X5',total_row[10]+total_row[12],total_custo_format)
        worksheet.write('W6','Consumo',header_format)
        worksheet.write('X6',total_row[14]+total_row[16],total_custo_format)
        worksheet.write('W7','Reativos',header_format)
        worksheet.write('X7',total_row[18]+total_row[20],total_custo_format)
        worksheet.set_column('W:X',22)
